...
PocketRisu se puede instalar de cuatro formas.
...
Extrae el zip y haz doble clic en `PocketRisu.exe`. Un navegador se abre automáticamente en `http://localhost:6001`.
