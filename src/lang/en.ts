...
export const languageEnglish = {
    ...
    accountTab: "Account",
    accountDesc: "Manage the site login session that gates this whole app (separate from the RisuAI password below).",
    accountLoggedInAs: "Logged in as",
    accountAdminBadge: "Admin",
    accountAdminPage: "Admin Page",
    accountChangePassword: "Change your password",
    accountNewPasswordPlaceholder: "New password",
    accountChangePasswordButton: "Change",
    accountPasswordChanged: "Password changed. Please log in again.",
