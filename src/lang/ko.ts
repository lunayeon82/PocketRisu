...
export const languageKorean = {
  ...
  autoOpenSingleCharacter: "캐릭터 목록 없이 바로 채팅으로 시작하기",
  ...
  accountTab: "계정",
  accountDesc: "앱 전체를 감싸는 사이트 로그인 세션을 관리합니다 (아래 RisuAI 비밀번호와는 별개입니다).",
  accountLoggedInAs: "로그인 계정",
  accountAdminBadge: "관리자",
  accountAdminPage: "관리자 페이지",
  accountChangePassword: "비밀번호 변경",
  accountNewPasswordPlaceholder: "새 비밀번호",
  accountChangePasswordButton: "변경",
  accountPasswordChanged: "비밀번호가 변경되었습니다. 다시 로그인해주세요.",
